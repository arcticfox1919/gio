...
void main() {
  group('#contentLength', () {
    test('is computed from bodyBytes', () {
      var request = gio.Request('POST', dummyUrl)..bodyBytes = [1, 2, 3, 4, 5];
    ...
    test('is computed from body', () {
      var request = gio.Request('POST', dummyUrl)..body = 'hello';
      expect(request.contentLength, equals(5));
    ...
    test('is not directly mutable', () {
      var request = gio.Request('POST', dummyUrl);
  ...
  group('#encoding', () {
    ...
    test('can be set', () {
      var request = gio.Request('POST', dummyUrl)..encoding = latin1;
  ...
  group('#finalize', () {
    test('returns a stream that emits the request body', () {
      var request = gio.Request('POST', dummyUrl)..body = 'Hello, world!';
      expect(request.finalize().bytesToString(),
          completion(equals('Hello, world!')));
    });

    test('freezes #persistentConnection', () {
      var request = gio.Request('POST', dummyUrl)..finalize();
  ...
  group('#method', () {
    test('must be a token', () {
      expect(() => gio.Request('LLAMA[0]', dummyUrl), throwsArgumentError);
    });
  });
}
